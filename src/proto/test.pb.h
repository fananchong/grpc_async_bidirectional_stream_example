...
class Frame final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::test::MsgEcho* release_echo();
  ...
  PROTOBUF_MUST_USE_RESULT ::test::MsgPing* release_ping();
...
inline ::test::MsgEcho* Frame::_internal_mutable_echo() {
  if (!_internal_has_echo()) {
    clear_Msg();
    set_has_echo();
    Msg_.echo_ = CreateMaybeMessage< ::test::MsgEcho >(GetArenaForAllocation());
  }
  return Msg_.echo_;
}
inline ::test::MsgEcho* Frame::mutable_echo() {
  ::test::MsgEcho* _msg = _internal_mutable_echo();
...
inline ::test::MsgPing* Frame::_internal_mutable_ping() {
  if (!_internal_has_ping()) {
    clear_Msg();
    set_has_ping();
    Msg_.ping_ = CreateMaybeMessage< ::test::MsgPing >(GetArenaForAllocation());
  }
  return Msg_.ping_;
}
inline ::test::MsgPing* Frame::mutable_ping() {
  ::test::MsgPing* _msg = _internal_mutable_ping();
...
void MsgEcho::set_data(ArgT0&& arg0, ArgT... args) {
